...
public class ASTSubtract extends ExpressionNote
{
    ...
    throws Exception
  {
    ...
    for (int i = 1; i < this._children.length; i++)
      localObject = OgnlOps.subtract(localObject, this._children[i].getValue(paramObject));
    return localObject;
  }
}

/* Location:           D:\Documents\Downloads\dex2jar-0.0.9.15\classes_dex2jar.jar
 * Qualified Name:     cn.suanya.synl.node.ASTSubtract
