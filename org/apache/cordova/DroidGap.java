  ...
  implements CordovaInterface
{
  ...
  {
    runOnUiThread(new DroidGap.4(this, this, paramString2, paramString1, paramString3, paramBoolean));
  }
  ...
  public void onReceivedError(int paramInt, String paramString1, String paramString2)
  {
    ...
    {
      runOnUiThread(new DroidGap.2(this, this, str));
      return;
    }
    if (paramInt != -2);
    for (boolean bool = true; ; bool = false)
    {
      runOnUiThread(new DroidGap.3(this, bool, this, paramString1, paramString2));
      return;
    }
  }
  ...
  {
    runOnUiThread(new DroidGap.5(this, this, paramInt));
  }
  ...
  public void spinnerStart(String paramString1, String paramString2)
  {
    ...
    this.spinnerDialog = ProgressDialog.show(this, paramString1, paramString2, true, true, new DroidGap.1(this, this));
  }
