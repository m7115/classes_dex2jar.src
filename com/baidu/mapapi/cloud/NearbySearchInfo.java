  ...
  String a()
  {
    ...
    try
    {
      ...
      if (this.location != null)
        localStringBuilder.append("&location=").append(this.location.getLatitudeE6() / 1000000.0D).append(',').append(this.location.getLongitudeE6() / 1000000.0D);
      localStringBuilder.append("&radius=").append(this.radius);
