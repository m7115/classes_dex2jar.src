  ...
  public void run()
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        localArrayList.add(new BasicNameValuePair("bloc", g.jdMethod_else()));
        if (g.jdMethod_goto() != null)
          localArrayList.add(new BasicNameValuePair("up", g.jdMethod_goto()));
        ...
        j.jdMethod_if(g.jdMethod_long(), "apn type : " + g.e());
        if (((g.e() == 1) || (g.e() == 4)) && ((g.jdMethod_new() - i) % 2 == 0))
        {
          j.jdMethod_if(g.jdMethod_long(), "apn type : ADD PROXY" + g.jdMethod_void() + g.g());
        ...
        if (j == 200)
        {
          ...
          Header localHeader = localHttpResponse.getEntity().getContentType();
          j.jdMethod_if(g.jdMethod_long(), "status error : " + localHeader);
          Message localMessage1 = g.jdMethod_try().obtainMessage(21);
          localMessage1.obj = str;
          localMessage1.sendToTarget();
          g.jdMethod_do(null);
          if ((i <= 0) && (g.jdMethod_try() != null))
          {
            j.jdMethod_if(g.jdMethod_long(), "have tried 3 times...");
            g.jdMethod_try().obtainMessage(62).sendToTarget();
          }
          g.jdMethod_if(null);
          g.a(false);
          return;
        ...
        localHttpPost.abort();
        Message localMessage2 = g.jdMethod_try().obtainMessage(63);
 ...
 * Qualified Name:     com.baidu.location.g.1
